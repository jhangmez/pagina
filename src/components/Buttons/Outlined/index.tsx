...
const Outlined: React.FC<ButtonProps> = ({
  ...
  return (
    <button className='w-[fit] h-10 rounded-[100px] flex-col justify-center items-center gap-2 inline-flex text-light-primary dark:text-dark-primary hover:text-light-primary disabled:text-light-onSurface border border-light-outline dark:border-dark-outline'>
